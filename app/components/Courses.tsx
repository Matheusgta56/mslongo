export default function Courses() {
  ...
  const courses = [
      ...
      { title: "Curso de DESIGN", url: "/img/design.svg", description: "O curso JSS é realizado por..." },
      { title: "Curso de Games", url: "/img/games.svg", description: "O curso JSS é realizado por..." },
      { title: "Curso de ROBÓTICA", url: "/img/robot.svg", description: "O curso JSS é realizado por..." }
  ]
